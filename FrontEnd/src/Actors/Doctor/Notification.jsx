...
const Notification = () => {
  ...
  useEffect(() => {
    ...
    const fetchNotifications = async () => {
      try {
        const response = await axios.post('http://localhost:9191/api/v1/authenticate/list-notifications', { email: 'anujag78@gmail.com' }); // Replace 'example@example.com' with the actual email
