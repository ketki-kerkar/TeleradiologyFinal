...
const OHIFRadiologist = () => {
  const authToken = 'eyJhbGciOiJIUzM4NCJ9.eyJzdWIiOiJsdW5hLmxvdmVnb29kQGV4YW1wbGUuY29tIiwiaWF0IjoxNzE1MDg5ODg3LCJleHAiOjE3MTUxMjU4ODd9.F6EUjKwwMvlCI1wDLBYjCkTgmsMNiRxwela9jfDxTvnPnf-Cwg7uyM4mQqwKaZij'; // Update with your authentication token
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const jsonUrlResponse = await axios.get('http://localhost:9191/api/v1/radiologist/get-json-aws-url', {
          params: {
            caseId: 1
          },
          headers: {
